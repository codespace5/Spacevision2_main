...
from .views import EmailTokenObtainPairView, SignUpView, ResetPasswordView,  EIADataView, CrudeOilView, ArticleView, EIAUpdateView
...
urlpatterns = [
    ...
    path('updatecrude/', EIAUpdateView.as_view(), name="update_crude"),
